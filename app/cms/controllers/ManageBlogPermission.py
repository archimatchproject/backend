...
class ManageBlogPermission(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (
            ...
            and admin.has_permission("add_blogthematic")
            and admin.has_permission("change_blogthematic")
            and admin.has_permission("delete_blogthematic")
            and admin.has_permission("view_blogthematic")
            and admin.has_permission("add_blogtag")
            and admin.has_permission("change_blogtag")
            and admin.has_permission("delete_blogtag")
            and admin.has_permission("view_blogtag")
        )
