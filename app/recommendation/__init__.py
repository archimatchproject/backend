...
DISTANCE_WEIGHT_CHOICES = generate_recommendation_choices(5, 30, "{value} points", gap=5)
PERFECT_MATCH_WEIGHT_CHOICES = generate_recommendation_choices(1, 10, "{value} points", gap=1)
ONGOING_PROJECTS_WEIGHT_CHOICES = generate_recommendation_choices(1, 10, "{value} points", gap=2)
...
NUM_RESULTS_CHOICES = generate_recommendation_choices(5, 50, "Top {value} results", gap=5)

# Choices for RecommendationSettings attributes with gaps
ARCHITECTURAL_STYLE_CHOICES = generate_recommendation_choices(1, 20, "{value} points", gap=1)
WORK_TYPE_CHOICES = generate_recommendation_choices(1, 15, "{value} points", gap=1)
PROJECT_CATEGORY_CHOICES = generate_recommendation_choices(1, 15, "{value} points", gap=1)
