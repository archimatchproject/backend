...
class ArchimatchUserCreatePWSerializer(serializers.Serializer):
    ...
    class Meta:
        """
        Meta class for ArchimatchUserCreatePWSerializer.
...
class ArchimatchUserResetPWSerializer(serializers.Serializer):
    """
    Serializer for creating ArchimatchUser with password.
    ...
    class Meta:
        """
        Meta class for ArchimatchUserResetPWSerializer.
