...
This module provides a serializer for the SupplierSpeciality  model, including nested
 serialization for the ArchimatchUser model.

Classes:
    SupplierSpeciality Serializer: Serializer for the SupplierSpeciality  model with
      nested ArchimatchUser.
"""
...
class SupplierSpecialitySerializer(serializers.ModelSerializer):
    ...
    SupplierSpeciality -specific fields.
