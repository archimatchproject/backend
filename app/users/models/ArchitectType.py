...
class ArchitectType(models.Model):
    ...
    Attributes:
        display (CharField): Name or display title of the architect type, maximum length of
        255 characters.
        icon (ImageField): Optional icon representing the architect type, stored in
        'ArchitectTypeIcons/' directory.
        short_def (TextField): Brief description or definition of the architect type,
